          ...
          <div className="lg:col-span-4 xl:col-span-3 flex flex-col gap-6">
            ...
            <div className="p-4 rounded-2xl bg-[#103334]/40 border border-[#3D4D55]/30 backdrop-blur-md flex items-center justify-between">
              ...
              <div className="flex items-center gap-1.5 bg-[#B58863]/10 border border-[#B58863]/20 px-3 py-1 rounded-xl">
                ...
                <span className="text-sm font-black text-[#B58863]">{movie.voteAverage.toFixed(1)}</span>
              </div>
            </div>
          ...
          <div className="lg:col-span-8 xl:col-span-9 flex flex-col gap-8">
            ...
            <div>
              <div className="flex flex-wrap items-center gap-2 text-[10px] font-extrabold uppercase tracking-widest text-[#A79E9C] mb-3">
                <span className="bg-[#3D4D55]/30 border border-[#3D4D55]/40 px-2 py-0.5 rounded-full">{movie.releaseDate.split("-")[0]}</span>
                <span>•</span>
                <span className="bg-[#3D4D55]/30 border border-[#3D4D55]/40 px-2 py-0.5 rounded-full">{movie.runtime} Min</span>
                <span>•</span>
                <span className="bg-[#B58863]/10 text-[#B58863] border border-[#B58863]/20 px-2.5 py-0.5 rounded-full">
                  Movie
                </span>
              </div>

              <h1 className="text-4xl sm:text-6xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-[#D3C3B9] via-[#D3C3B9] to-[#B58863] mb-3 leading-tight">
                {movie.title}
              </h1>
            ...
            <div className="max-w-3xl">
              ...
              {reviews.length > 0 ? (
                ...
                <p className="text-xs sm:text-sm text-[#A79E9C] italic py-6 pl-1">No reviews written for this movie yet.</p>
              )}
            </div>
          </div>
        </div>
