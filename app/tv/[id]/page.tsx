      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 pt-20 md:pt-36">
        <div className="flex flex-col md:flex-row gap-8 lg:gap-12">
          ...
          <div className="flex-1">
            <div className="flex flex-wrap items-center gap-3 text-zinc-400 text-xs font-semibold uppercase tracking-wider mb-2">
              ...
              <span>•</span>
              <span>{show.runtime} Min / Episode</span>
              <span>•</span>
            ...
            {show.tagline && (
              <p className="text-zinc-400 italic text-sm md:text-base mb-6">"{show.tagline}"</p>
            )}
              ...
              <div className="flex items-center gap-2 flex-wrap text-zinc-300 w-full">
                {session ? (
                  ...
                  <Link href="/login" className="text-xs font-semibold text-indigo-400 hover:underline">
                    Sign in to track, rate &amp; review this TV show
                  </Link>
                )}
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="text-sm text-zinc-300 leading-relaxed max-w-3xl">{show.overview}</p>
            </div>
        ...
        <div className="mt-16 max-w-4xl">
          ...
          {reviews.length > 0 ? (
            ...
            <p className="text-sm text-zinc-500 italic py-6">No reviews written for this TV show yet.</p>
          )}
        </div>
      </div>
    </div>
