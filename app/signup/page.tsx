    ...
    <div className="flex min-h-screen items-center justify-center bg-[#0f1a1b] px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="mt-2 text-sm text-[#A79E9C]">Join the movie tracker community</p>
        </div>

        {/* Signup Card */}
        <div className="bg-[#103334]/50 backdrop-blur-xl border border-[#3D4D55]/50 p-8 rounded-2xl shadow-2xl shadow-black/50">
          <h2 className="text-2xl font-bold text-[#D3C3B9] mb-6 text-center">Create Your Account</h2>
          ...
          <div className="relative flex py-2 items-center mb-6">
            ...
            <span className="flex-shrink mx-4 text-[10px] font-mono text-[#A79E9C]/60 uppercase tracking-widest">or register below</span>
            <div className="flex-grow border-t border-[#3D4D55]/40"></div>
          </div>
          ...
          <form action={formAction} className="space-y-4">
            ...
            <div>
              <label htmlFor="name" className="block text-xs font-semibold text-[#A79E9C] uppercase tracking-wider mb-2">
                Full Name
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="password" className="block text-xs font-semibold text-[#A79E9C] uppercase tracking-wider mb-2">
                Password
              </label>
              <input
                id="password"
            ...
            <button
              type="submit"
              disabled={isPending}
              className="w-full py-3 px-4 rounded-xl bg-gradient-to-r from-[#B58863] to-[#d4a87c] hover:opacity-90 text-sm font-semibold text-[#0f1a1b] shadow-lg shadow-[#B58863]/20 active:scale-[0.98] transition-all duration-200 disabled:opacity-50 disabled:pointer-events-none cursor-pointer mt-4"
            >
              {isPending ? (
          ...
          <div className="mt-8 pt-6 border-t border-[#3D4D55]/40 text-center">
            <p className="text-sm text-[#A79E9C]">
              ...
              <Link href="/login" className="font-semibold text-[#B58863] hover:text-[#d4a87c] transition-colors">
                Sign In
              </Link>
            </p>
          </div>
